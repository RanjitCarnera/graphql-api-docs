...
const Divisions = () => {
     ...
     const restApiEndpoints = [
    {
      ...
      description: "Create a new division with the specified configuration.",
      method: "POST" as const,
      url: "https://api.constructionintelligence.com/api/division",
      headers: {
    ...
    {
      id: "list-divisions",
      title: "Get all Divisions list",
      description: "Retrieve a list of divisions with optional filtering.",
      method: "POST" as const,
      url: "https://api.constructionintelligence.com/api/divisions",
      headers: {
        "content-type": "application/json",
        "Authorization": " "
      },
    ...
    },
    {
      ...
      url: "https://api.constructionintelligence.com/api/divisions/id",
      headers: {
        "content-type": "application/json",
        "Authorization": " "
      },
    ...
    {
      id: "update-division",
      title: "Update Division record",
      description: "Update a division record by its ID.",
      method: "PUT" as const,
      url: "https://api.constructionintelligence.com/api/divisions/id",
      headers: {
        "content-type": "application/json",
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full mb-8">
          ...
          <TabsContent value="rest-api" className="space-y-6">
              ...
              <p className="mb-4">
                Use these REST API endpoints to interact with division programmatically.
              </p>
